import { ADOPT, TRIAL, ASSESS, HOLD, convert } from "../utils/types";
  ...
  <ul className="prose prose-sm max-w-none">
    ...
    >
      ...
      <p>
        ...
        production systems, accompanied by clear guidelines, best practices and
        optionally training and enablement.
        <br />
    ...
    >
      <h4>Assess</h4>
      <p>
        The following items have a high potential for our tech roadmap. However,
        we haven’t tried them so far.
        <br />
